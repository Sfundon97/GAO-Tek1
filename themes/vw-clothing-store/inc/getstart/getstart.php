    ...
    <div class="tab-sec">
    	<div class="tab">
			...
			<button class="tablinks" onclick="vw_clothing_store_open_tab(event, 'theme_pro')"><?php esc_html_e( 'Get Premium', 'vw-clothing-store' ); ?></button>
  			<button class="tablinks" onclick="vw_clothing_store_open_tab(event, 'free_pro')"><?php esc_html_e( 'Support', 'vw-clothing-store' ); ?></button>
		</div>
		    ...
		    <div class="featurebox">
				...
				<div class="table-image">
					<table class="tablebox">
						...
						<tbody>
							<tr>
								<td><?php esc_html_e('Theme Customization', 'vw-clothing-store'); ?></td>
							...
							<tr>
								<td><?php esc_html_e('Slider Settings', 'vw-clothing-store'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr class="odd">
								<td><?php esc_html_e('Number of Slides', 'vw-clothing-store'); ?></td>
								<td class="table-img"><?php esc_html_e('4', 'vw-clothing-store'); ?></td>
								<td class="table-img"><?php esc_html_e('Unlimited', 'vw-clothing-store'); ?></td>
							</tr>
							<tr>
							...
							<tr>
								<td><?php esc_html_e('Theme sections', 'vw-clothing-store'); ?></td>
							...
							<tr class="odd">
								<td><?php esc_html_e('Page Templates & Layout', 'vw-clothing-store'); ?></td>
								<td class="table-img">0</td>
								<td class="table-img"><?php esc_html_e('2(Left/Right Sidebar)', 'vw-clothing-store'); ?></td>
							</tr>
							<tr>
		...
		<div id="free_pro" class="tabcontent">
		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-star-filled"></span><?php esc_html_e('Pro Version', 'vw-clothing-store'); ?></h4>
				<p> <?php esc_html_e('To gain access to extra theme options and more interesting features, upgrade to pro version.', 'vw-clothing-store'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_CLOTHING_STORE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Get Pro', 'vw-clothing-store'); ?></a>
				</div>
		  	</div>
		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-cart"></span><?php esc_html_e('Pre-purchase Queries', 'vw-clothing-store'); ?></h4>
				<p> <?php esc_html_e('If you have any pre-sale query, we are prepared to resolve it.', 'vw-clothing-store'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_CLOTHING_STORE_CONTACT ); ?>" target="_blank"><?php esc_html_e('Question', 'vw-clothing-store'); ?></a>
				</div>
		  	</div>
		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-admin-customizer"></span><?php esc_html_e('Child Theme', 'vw-clothing-store'); ?></h4>
				<p> <?php esc_html_e('For theme file customizations, make modifications in the child theme and not in the main theme file.', 'vw-clothing-store'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_CLOTHING_STORE_CHILD_THEME ); ?>" target="_blank"><?php esc_html_e('About Child Theme', 'vw-clothing-store'); ?></a>
				</div>
		  	</div>

		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-admin-comments"></span><?php esc_html_e('Frequently Asked Questions', 'vw-clothing-store'); ?></h4>
				<p> <?php esc_html_e('We have gathered top most, frequently asked questions and answered them for your easy understanding. We will list down more as we get new challenging queries. Check back often.', 'vw-clothing-store'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_CLOTHING_STORE_FAQ ); ?>" target="_blank"><?php esc_html_e('View FAQ','vw-clothing-store'); ?></a>
				</div>
		  	</div>

		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-sos"></span><?php esc_html_e('Support Queries', 'vw-clothing-store'); ?></h4>
				<p> <?php esc_html_e('If you have any queries after purchase, you can contact us. We are eveready to help you out.', 'vw-clothing-store'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_CLOTHING_STORE_SUPPORT ); ?>" target="_blank"><?php esc_html_e('Contact Us', 'vw-clothing-store'); ?></a>
				</div>
		  	</div>
		</div>
	</div>
