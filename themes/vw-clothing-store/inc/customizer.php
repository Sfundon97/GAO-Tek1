...
function vw_clothing_store_customize_register( $wp_customize ) {
  ...
  $wp_customize->add_control('vw_clothing_store_footer_widgets_content',array(
	...
	// footer social icon
	$wp_customize->add_setting( 'vw_clothing_store_footer_icon',array(
	  'default' => false,
	  'transport' => 'refresh',
	  'sanitize_callback' => 'vw_clothing_store_switch_sanitization'
	) );
	$wp_customize->add_control( new VW_Clothing_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_clothing_store_footer_icon',array(
	  'label' => esc_html__( 'Footer Social Icon','vw-clothing-store' ),
	  'section' => 'vw_clothing_store_footer'
	)));
	...
	*/
	public function sections( $manager ) {
		...
		$manager->add_section( new VW_Clothing_Store_Customize_Section_Pro( $manager,'vw_clothing_store_go_pro', array(
			...
			'pro_url'  => esc_url('https://www.vwthemes.com/themes/clothing-store-wordpress-theme/'),
		) )	);
