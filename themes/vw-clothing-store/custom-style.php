<?php
	...
	if($vw_clothing_store_first_color != false){
		$vw_clothing_store_custom_css .='#sidebar ul li::before,#footer-2{';
...
/*------------------ Slider Opacity -------------------*/
	...
	if($vw_clothing_store_banner_image != false){
		$vw_clothing_store_custom_css .='#banner{';
			$vw_clothing_store_custom_css .='background: url('.esc_url($vw_clothing_store_banner_image).');';
		$vw_clothing_store_custom_css .='}';
	}
	...
	$vw_clothing_store_footer_icon = get_theme_mod('vw_clothing_store_footer_icon');
	if($vw_clothing_store_footer_icon == false){
		$vw_clothing_store_custom_css .='#footer-2 p{';
			$vw_clothing_store_custom_css .='width:100%; text-align:center; float:none;';
		$vw_clothing_store_custom_css .='}';
	}
