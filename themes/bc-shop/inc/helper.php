              ...
              <div class="row">
                  ...
                  <div class="col-md-7 col-sm-7"> 
                    ...
                    <div class="pull-left">
                        ...
                        <?php
                        printf( /* translators:straing */  esc_html__( 'Theme: %1$s by %2$s.', 'bc-shop' ), 'BC SHOP', '<a href="' . esc_url( __( 'https://athemeart.com/downloads/bc-business-consulting/', 'bc-shop' ) ) . '" target="_blank">' . esc_html__( 'aThemeArt', 'bc-shop' ) . '</a>' ); ?>
                    </div>
				  </div>
...
if ( ! function_exists( 'bcshop_product_review_comment_form_args' ) ) :
	...
	function bcshop_product_review_comment_form_args( $comment_form ) {
		...
		$comment_author = !empty($comment_form['comment_author']) ?esc_attr( $comment_form['comment_author'] ) :'';
		$author_email   = !empty($comment_form['comment_author_email']) ?esc_attr( $comment_form['comment_author_email'] ) :'';
			...
			$comment_form = array(
						...
						'fields'               => array(
							...
							'author' =>'<div class="row"><div class="form-group col-md-6 col-sm-6">' . '<input id="author" placeholder="' . esc_attr__( 'Your Name', 'bc-shop'  ) . '" name="author"  type="text" value="' . esc_attr( $comment_author ) . '" size="30" class="form-control" /><span class="required">*</span>
				</div>',
							'email'  => '<div class="form-group col-md-6 col-sm-6">' . '<input id="email" placeholder="' . esc_attr__( 'Your Email', 'bc-shop'  ) . '" name="email" type="text" value="' . esc_attr(  $author_email ) .
